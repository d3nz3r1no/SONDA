...
def handle_greeting(message):
    ...
    bot.reply_to(message,
                 "Привет! Я бот SONDA. Что вас интересует?",
...
def handle_help(message):
    ...
    help_text = (
        ...
        "• Просматривайте историю командой /history\n"
        "• Очищайте историю через /clearmyhistory\n\n"
...
def handle_about(message):
    ...
    about_text = (
        "🤖 Обо мне:\n\n"
        "Я - бот SONDA, созданный для удобных вычислений.\n"
        "Мои особенности:\n"
        "- Удобный инженерный калькулятор\n"
